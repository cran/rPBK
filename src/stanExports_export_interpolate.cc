...
#include "stanExports_export_interpolate.h"

RCPP_MODULE(stan_fit4export_interpolate_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_export_interpolate")
